        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>Cập nhật chi tiết khách hàng</b></h4>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                            ...
                            <div class="form-group">
                                <label for="" class="control-label">SĐT khách hàng</label>
                            ...
                            <div class="form-group">
                                <label for="email" class="control-label">Email khách hàng</label>
                            ...
                            <div class="form-group">
                                ...
                                <small class="text-muted"><i>Để trống nếu bạn không muốn cập nhật mật khẩu của mình.</i></small>
                            </div>
                            <div class="form-group">
                                ...
                                <small class="text-muted"><i>Nhập mật khẩu hiện tại của bạn để cập nhật thông tin chi tiết.</i></small>
                            </div>
