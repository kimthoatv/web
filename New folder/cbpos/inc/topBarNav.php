            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <?php 
                        $cat_qry = $conn->query("SELECT * FROM categories where status = 1  limit 9");
                        ...
                        <?php endwhile; ?>
                        <?php if($count_cats > 3): ?>
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=view_categories">Tất cả danh mục sản phẩm</a></li>
                        <?php endif; ?>
